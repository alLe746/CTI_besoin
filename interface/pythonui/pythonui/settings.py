"""
Django settings for pythonui project.
...
SECRET_KEY = 'django-insecure-knn%_ep2g=@rg2tc5ksgyx$ajol+t)ebe!4i#0_!o@%ygaq-ea'
...
WSGI_APPLICATION = 'pythonui.wsgi.application'
